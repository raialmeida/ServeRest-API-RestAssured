...
import br.com.serverest.services.produtos.payloads.PutProdutosByIdPayload;
import br.com.serverest.services.produtos.requests.PutProdutosByIdRequest;
...
public class PutProdutosByIdTest extends Hooks {
    ...
    public void validarSchemaPutProdutosPorId() {
        ...
        PutProdutosByIdRequest.enviar(idProduto, payload)
                .assertThat()
                .statusCode(200)
                .body(matchesJsonSchemaInClasspath("services/produtos/schema/PutProdutosByIdSchema.json"));
    }
}
