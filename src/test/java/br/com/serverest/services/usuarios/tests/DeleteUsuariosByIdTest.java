...
import br.com.serverest.services.usuarios.requests.DeleteUsuariosByIdRequest;
...
public class DeleteUsuariosByIdTest extends Hooks {
    ...
    public void validarSchemaDeleteUsuariosPorId() {
        ...
        DeleteUsuariosByIdRequest.enviar(idUsuario)
                .assertThat()
                .statusCode(200)
                .body(matchesJsonSchemaInClasspath("services/usuarios/schema/DeleteUsuariosByIdSchema.json"));
    }
}
