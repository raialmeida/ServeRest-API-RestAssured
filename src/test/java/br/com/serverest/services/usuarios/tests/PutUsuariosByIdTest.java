...
import br.com.serverest.services.usuarios.payloads.PutUsuariosByIdPayload;
import br.com.serverest.services.usuarios.requests.PutUsuariosByIdRequest;
...
public class PutUsuariosByIdTest extends Hooks {
    ...
    public void validarSchemaPutUsuariosPorId() {
        ...
        PutUsuariosByIdRequest.enviar(idUsuario, payload)
                .assertThat()
                .statusCode(200)
                .body(matchesJsonSchemaInClasspath("services/usuarios/schema/PutUsuariosByIdSchema.json"));
    }
}
